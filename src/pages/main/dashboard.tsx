...
export default function DashboardPage() {
  const { setRightbarOpen } = useOutletContext<{ setRightbarOpen: React.Dispatch<React.SetStateAction<boolean>> }>();
    ...
    <main className="flex-grow p-5 overflow-y-auto">
      ...
      <div className="mb-5">
        ...
        <div className="grid grid-cols-5 gap-2">
          <NavLink to="/healthcare-monitoring" className="flex flex-col items-center justify-between p-2 rounded-xl text-center cursor-pointer hover:bg-gradient-to-b hover:from-teal-300 hover:to-teal-700 hover:text-white transition">
            <img src={monitoring} alt="Monitoring" className="w-30 h-30 mb-1"/>
            <p>Healthcare Monitoring</p>
          </NavLink>
          <NavLink to="/doctors" className="flex flex-col items-center justify-between p-2 rounded-xl text-center cursor-pointer hover:bg-gradient-to-b hover:from-teal-300 hover:to-teal-700 hover:text-white transition">
            <img src={doctor} alt="Doctor" className="w-30 h-30 mb-1"/>
            <p>Doctor</p>
          </NavLink>
          <NavLink to="/laboratory" className="flex flex-col items-center justify-between p-2 rounded-xl text-center cursor-pointer hover:bg-gradient-to-b hover:from-teal-300 hover:to-teal-700 hover:text-white transition">
            <img src={laboratory} alt="Lab" className="w-30 h-30 mb-1"/>
            <p>Laboratory</p>
          </NavLink>
          <NavLink to="/pharmacy" className="flex flex-col items-center justify-between p-2 rounded-xl text-center cursor-pointer hover:bg-gradient-to-b hover:from-teal-300 hover:to-teal-700 hover:text-white transition">
            <img src={pharmacy} alt="Pharmacy" className="w-30 h-30 mb-1"/>
            <p>Pharmacy</p>
          </NavLink>
          <NavLink to="/healthcare" className="flex flex-col items-center justify-between p-2 rounded-xl text-center cursor-pointer hover:bg-gradient-to-b hover:from-teal-300 hover:to-teal-700 hover:text-white transition">
